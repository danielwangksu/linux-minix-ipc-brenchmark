all: latency_pxmsg bandwidth_pxmsg latency_udpsocket_client latency_udpsocket_server
...
clean:
	rm -rf *~ latency_pxmsg bandwidth_pxmsg latency_udpsocket_client latency_udpsocket_server