all: latency_pxmsg bandwidth_pxmsg latency_udpsocket_client latency_udpsocket_server latency_unixsocket_client latency_unixsocket_server bandwidth_unixsocket bandwidth_udpsocket_client bandwidth_udpsocket_server
...
clean:
	rm -rf *~ latency_pxmsg bandwidth_pxmsg latency_udpsocket_client latency_udpsocket_server latency_unixsocket_client latency_unixsocket_server bandwidth_unixsocket bandwidth_udpsocket_client bandwidth_udpsocket_server